...
public class AddDeliveryBankPage {
	...
	public AddDeliveryBankPage(WebDriver driver)
	{
	...
	public void setDeliveryBank(String bankCode, String bankName, String bankCountry, String bankCity, String bankState ) throws InterruptedException
	{
